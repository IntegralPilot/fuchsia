...
// Run the above script whenever src/storage/lib/block_protocol/types.h
// has changed.
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of BlockFifoRequest"][::std::mem::size_of::<BlockFifoRequest>() - 64usize];
    ...
    ["Offset of field: BlockFifoRequest::total_compressed_bytes"]
        [::std::mem::offset_of!(BlockFifoRequest, total_compressed_bytes) - 20usize];
...
pub struct BlockFifoResponse {
    ...
    pub count: u32,
    pub padding_to_match_request_size_and_alignment: [u64; 6usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of BlockFifoResponse"][::std::mem::size_of::<BlockFifoResponse>() - 64usize];
